        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="p-1.5 bg-gray-100 dark:bg-white/5 rounded-xl border border-black/10 dark:border-white/10">
                <img src={accountInfo?.service_site_logo ? `${BASE_URL}${encodeURI(accountInfo.service_site_logo)}` : ""} alt={accountInfo?.service_site_name || 'Site'} className="h-8 w-auto" />
              </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="grid grid-cols-1 gap-2">
              {[
                ...
                <li key={i}>
                  <a href={link.href} className="text-xs font-bold text-black/60 dark:text-white/60 hover:text-black dark:text-white hover:pl-2 transition-all duration-300 flex items-center gap-2 group">
          ...
          <div className="space-y-4">
            ...
            <a 
              ...
              className="inline-flex items-center gap-3 px-6 py-2.5 text-black font-black text-xs uppercase tracking-widest rounded-xl hover:-translate-y-1 transition-all duration-300 shadow-[0_10px_25px_-5px_rgba(34,197,94,0.4)]"

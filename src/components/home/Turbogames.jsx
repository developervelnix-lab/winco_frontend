...
const GameSection = ({ title, games }) => {
  ...
  return (
    <div className="game-section relative w-full px-3 py-3 bg-gray-900 rounded-lg shadow-lg">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-1.5 py-1.5 rounded-lg text-sm font-sans transition-all duration-300 ${showAll
      ...
      {showPopup && (
        <div className="fixed inset-0 bg-gray-900 z-[9999] overflow-y-auto">
          <div className="max-w-screen-2xl mx-auto px-4 py-6">
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-md font-sans text-white">{title}</h2>
              </div>
            </div>
